...
// In der jeweiligen index.php: set_exception_handler('ExtException_handler');
// Dient der schoenen Ausgabe bei ExtExceptions die nicht mit 'try-catch' abgefangen werden
// Fehler: 'Fatal error: Uncaught exception ExtException ... '
function ExtException_handler($except) {
  print $except->errorMessage();
}
?>